...
// Validation (do not comment)
    ...
    COLYBER_2ND_ACC == COLYBER_SENSOR_MPU6500SPI /* other accelerometers */)
#error "Invalid accelerometer"
#endif
#if !(                                              \
    COLYBER_2ND_GYRO == COLYBER_SENSOR_NO_SENSOR || \
    COLYBER_2ND_GYRO == COLYBER_SENSOR_MPU6050 ||   \
    COLYBER_2ND_GYRO == COLYBER_SENSOR_MPU6500SPI /* other gyroscopes */)
#error "Invalid gyroscope"
#endif
#if !(                                          \
    COLYBER_MAGN == COLYBER_SENSOR_NO_SENSOR || \
    COLYBER_MAGN == COLYBER_SENSOR_HMC5883L /* other magnetometers... */)
#error "Invalid magnetometer"
#endif
#if !(                                         \
    COLYBER_GPS == COLYBER_SENSOR_NO_SENSOR || \
    COLYBER_GPS == COLYBER_SENSOR_TINY_GPS_PLUS /* other gps sensors... */)
